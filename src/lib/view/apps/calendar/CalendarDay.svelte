<script>
	...
	import { Button, Modal, ModalBody, ModalHeader, Form, Input, Label } from 'sveltestrap';
				...
				<ModalBody>
					<Form class="c-event-form">
						...
						<div class="button-group d-flex justify-content-end pt-25">
							...
							>
							<Button color="primary" size="default" class="fs-15 btn-squared text-capitalize"
								>save
							</Button>
						</div>
					</Form>
				...
				<div class="card-body">
					<div class="draggable-events" id="draggable-events">
						<div class="draggable-events__top d-flex justify-content-between">
							<h6>My Calendars</h6>
							<a href="#"> <img class="svg" alt="" src={'/img/svg/plus.svg'} /></a>
						</div>
						<ul class="draggable-event-list">
							<li
								class="draggable-event-list__single d-flex align-items-center"
								data-class="primary"
							>
								<span class="badge-dot badge-primary" />
							...
							>
								<span class="badge-dot badge-secondary" />
							...
							<li
								...
								data-class="warning"
							>
								<span class="badge-dot badge-warning" />
